...
public class fusuario {
    ...
    public DefaultTableModel mostrar(String Buscar){
        ...
        String [] titulos= {"ID","Nombre","A.Paterno","A.Materno","T.Doc","N.Doc","Dirección","Celular","Cargo","User","Contra"};
        ...
        sSQL="select p.idpersona,p.nombre,p.apellidopaterno,p.apellidomaterno,p.tipodocumento,p.numdocumento,"+
                "p.direccion,p.celular,u.cargo,u.user,u.contra from persona p inner join usuarios u " +
        ...
        try {
            ...
            while(rs.next()){
                ...
                registro [9]=rs.getString("user");
                registro [10]=rs.getString("contra");
    ...
    public boolean insertar(usuario usr){
        ...
        sSQL="insert into persona (nombre,apellidopaterno,apellidomaterno,tipodocumento,"+
                ...
                "values (?,?,?,?,?,?,?)";
        sSQL2="insert into usuarios (idpersona,cargo,user,contra)"+
        ...
        try {
            ...
            pst2.setString(1, usr.getCargo());
            pst2.setString(2, usr.getUser());
            pst2.setString(3, usr.getContra());
    ...
    public boolean editar(usuario usr){
       ...
       sSQL2="update usuarios set cargo=?,user=?,contra=? where idpersona=?";
