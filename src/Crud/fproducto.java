...
public class fproducto {
    ...
    public DefaultTableModel mostrar(String Buscar){
        ...
        String [] titulos= {"ID","Nombre","Categoria","Precio"};
    ...
    public boolean insertar(producto pdt){
        sSQL="insert into productos (nombre,categoria,precio)"+
                "values (?,?,?)";
        
        try {
            PreparedStatement pst=cn.prepareStatement(sSQL);
            pst.setString(1, pdt.getNombre());
            pst.setString(2, pdt.getCategoria());
    ...
    public boolean editar(producto pdt){
        sSQL="update productos set nombre=?,categoria=?,precio=?"+
                "where idproductos=?";
