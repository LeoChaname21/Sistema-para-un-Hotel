...
public class fpago {
    ...
    public boolean eliminar(Pago pg){
        ...
        sSQL="select * from pago where fecha_pago between '"+Buscar+"' and '"+buscar2+"' order by fecha_pago desc";//order by idpago desc
        ...
        sSQL="select * from pago where fecha_pago between '"+Buscar+"' and '"+buscar2+"' and tipo_pago = '"
                +tipopago+ "' order by fecha_pago desc";//order by idpago desc
