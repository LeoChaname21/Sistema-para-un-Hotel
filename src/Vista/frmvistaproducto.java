...
public class frmvistaproducto extends javax.swing.JFrame {
    ...
    private void jtblProductosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblProductosMousePressed
        ...
        cod=jtblProductos.getValueAt(fila, 0).toString();
        nombre=jtblProductos.getValueAt(fila, 1).toString();
        precio=jtblProductos.getValueAt(fila, 3).toString();
        
        frmConsumo.txtidproducto.setText(cod);
        frmConsumo.txtProducto.setText(nombre);
        frmConsumo.txtPrecioVenta.setText(precio);
        this.dispose();
