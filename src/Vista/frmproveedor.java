...
public class frmproveedor extends javax.swing.JInternalFrame {
    ...
    public frmproveedor() {
        ...
        for (int i = 0; i < jtblProveedor.getColumnCount(); i++) {
            jtblProveedor.getColumnModel().getColumn(i).setCellRenderer(centerRenderer);
        }
    }
    ...
    void mostrar(String buscar) {
        try {
            ...
            jtblProveedor.setModel(noeditable);
            ocultar_columnas();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "Registro de Proveedores\n", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 22))); // NOI18N
        ...
        jcbtipodoc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "  ", "DNI", "RUC" }));
        ...
        txtServicio.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "Listado de Proveedores\n", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 22))); // NOI18N
    ...
    private void txtDireccionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDireccionKeyTyped
        ...
        if (!Character.isLetter(c) && !Character.isDigit(c) && c != ' ' && c != '.' && c != KeyEvent.VK_BACK_SPACE) {
            evt.consume(); // Ignorar el evento de teclado
            JOptionPane.showMessageDialog(null, "El carácter que ingresó no es válido","", JOptionPane.ERROR_MESSAGE);
        }
